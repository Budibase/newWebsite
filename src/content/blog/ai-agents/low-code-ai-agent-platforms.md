...
description: "Take a look at our round-up of the top low-code AI agent platforms."
...
- [What is a low-code AI agent platform?](#what-is-a-low-code-ai-agent-platform)
  - [Low-code vs no-code agents](#low-code-vs-no-code-agents)
- [What to look for in a low-code agent builder](#what-to-look-for-in-a-low-code-agent-builder)
  - [Types of agent builders](#types-of-agent-builders)
  - [Features and decision points](#features-and-decision-points)
- [6 low-code AI agent platforms for 2026](#6-low-code-ai-agent-platforms-for-2026)
...
5. [Microsoft Copilot Studio](#5-microsoft-copilot-studio)
6. [Botpress](#6-botpress)
...
Check out our [Agents overview](https://budibase.com/product/agents/) to learn more about transforming your processes with Budibase.
...
Take a look at our round-up of [n8n alternatives](https://budibase.com/blog/alternatives/n8n/) to learn more.
...
![Low-Code AI Agent Platforms Langflow](https://res.cloudinary.com/daog6scxm/image/upload/v1771844143/cms/alternatives/anythingllm/LangFlow_w9rvdm.webp "LangFlow") 
...
![Copilot Studio](https://res.cloudinary.com/daog6scxm/image/upload/v1776266361/cms/alternatives/low-code-agents/Copilot_Studio_tnhrpl.webp "Copilot Studio")(Copilot Studio Website)
...
![Botpress](https://res.cloudinary.com/daog6scxm/image/upload/v1776266360/cms/alternatives/low-code-agents/Botpress_cc79ss.webp "Botpress")(Botpress Website)
