...
Budibase is the ideal solution for building [internal tools](https://budibase.com/product/apps/) on top of any data. We offer dedicated connectors to query all kinds of RDBMSs, NoSQL tools, API, spreadsheets, and more, alongside our built-in database.
