...
author: "Joe Johnston"
socialImage: "/img/img/apps-list.png"
draft: false
---
...
- Budibase supports all kinds of APIs, RDBMSs, and NoSQL tools, complete with custom views and autogenerated layouts.
- We offer a range of AI functionality which can be powered by the LLM of your choice using custom configs.
